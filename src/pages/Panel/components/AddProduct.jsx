      ...
      <div className="pm">
        <div className="pm-container">
          <div className="pm-toolbar">
            <Link to="/panel" className="pm-btn">
              ← Wróć do panelu
            </Link>
          </div>
          ...
          <div className="pm-card" style={{ marginTop: 16 }}>
            <div className="pm-card-header">
              <div className="pm-card-title">Dodaj produkt</div>
            </div>
            ...
            <form onSubmit={submit} className="pm-form-grid" style={{ padding: 16 }}>
              ...
              <label className="pm-field">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setF({ ...f, country_of_origin: e.target.value })
                  }
                />
              </label>
              ...
              <label className="pm-field">
                ...
                <input
                  ...
                  step="0.01"
                  value={f.price1}
                  onChange={(e) => setF({ ...f, price1: e.target.value })}
                  required
                />
              </label>
              ...
              <label className="pm-field">
                ...
                <input
                  ...
                  accept="image/*"
                  onChange={(e) =>
                    setF({ ...f, picture: e.target.files?.[0] ?? null })
                  }
                />
              </label>
